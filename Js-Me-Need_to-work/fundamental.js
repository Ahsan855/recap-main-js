...
/* function myMark(mark){
    if(mark > 100 || mark < 0){
        console.log('please valid mark becuase 0 or 100 more hobe na');
    }
    else if(mark >= 0 && mark <= 32){
        console.log(' You are fail in the exam, never give up try again leter');
    }
    else if(mark === 33){
        console.log('you have pass now');
    }
...
console.log(mySelf.rionDetails.home);
console.log(mySelf.bestFriends[3]);